...
public class player1 : MonoBehaviour
{
    ...
    private float h = 0.0f;//°¡·Î  xÃà
    private float v = 0.0f;//¼¼·Î yÃà
    private Rigidbody rb;//rigidbody ÀúÀåº¯¼ö
    private Transform tr;//transform ÀúÀåº¯¼ö

    [SerializeField] private playerMouseRotate mouseRotate;//¸¶¿ì½º È¸Àü¿¡ °üÇÑ°Íµé ÀúÀåÇÏ´Â º¯¼ö(µ¥ÀÌÅÍ Å¸ÀÔ playerMouseRotate)
    [SerializeField] private Camera _camera;//Ä«¸Ş¶ó ¿¡ °üÇÑ °Íµé ÀúÀåÇÏ´Â º¯¼ö(µ¥ÀÌÅÍ Å¸ÀÔ Camera)
